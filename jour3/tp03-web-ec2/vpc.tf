...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "TP-PMONNIER-public-${each.key}"
    Tier = "public"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "TP-PMONNIER-private-${each.key}"
    Tier = "private"
  }
}
